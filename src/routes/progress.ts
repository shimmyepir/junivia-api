 ...
 */
router.get('/:puzzleId', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId;
 ...
 */
router.put('/:puzzleId', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId;
    const { puzzleId } = req.params;
 ...
 */
router.delete('/:puzzleId', async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId;
    const { puzzleId } = req.params;
